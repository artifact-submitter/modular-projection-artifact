...
namespace CertifiedJLFast.Results.Affine.L2.Upper
...
theorem ternaryAffineL2Upper192Threshold287Bits128 :
    AffineL2UpperTailAt
      ...
      (failureTarget 128) :=
  CertifiedJLFast.Results.L2.Upper.Rows192Bits128.ternaryL2Upper287.to_affine
...
theorem ternaryAffineL2Upper256Threshold338Bits128 :
    AffineL2UpperTailAt
      ...
      (failureTarget 128) :=
  CertifiedJLFast.Results.L2.Upper.Rows256Bits128.ternaryL2Upper338.to_affine
...
theorem ternaryAffineL2Upper512Threshold607Bits192 :
    AffineL2UpperTailAt
      ...
      (failureTarget 192) :=
  CertifiedJLFast.Results.L2.Upper.Rows512Bits192.ternaryL2Upper607.to_affine
...
theorem ternaryAffineL2Upper256Threshold406Bits192 :
    AffineL2UpperTailAt
      ...
      (failureTarget 192) :=
  CertifiedJLFast.Results.L2.Upper.Rows256Bits192.ternaryL2Upper406.to_affine
...
theorem ternaryAffineL2Upper384Threshold509Bits192 :
    AffineL2UpperTailAt
      ...
      (failureTarget 192) :=
  CertifiedJLFast.Results.L2.Upper.Rows384Bits192.ternaryL2Upper509.to_affine
...
theorem ternaryAffineL2Upper512Threshold681Bits256 :
    AffineL2UpperTailAt
      ...
      (failureTarget 256) :=
  CertifiedJLFast.Results.L2.Upper.Rows512Bits256.ternaryL2Upper681.to_affine

end CertifiedJLFast.Results.Affine.L2.Upper
