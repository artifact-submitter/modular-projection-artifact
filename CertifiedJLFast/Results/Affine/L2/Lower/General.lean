...
/-! # General affine Euclidean bounds using the existing fast certificate assumptions -/

namespace CertifiedJLFast.Results.Affine.L2.Lower.General
...
end CertifiedJLFast.Results.Affine.L2.Lower.General
