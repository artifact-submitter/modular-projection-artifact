...
/-!
# Soundness facts for the 256-row, 152-bit, threshold-365 instance
...
namespace CertifiedJL.SparseUpperContourFamily.Instances.Rows256Bits152Threshold365Soundness
...
theorem lowProfileFacts : ∀ box ∈ profileBoxes,
  ...
  all_goals exact ⟨128, by norm_num⟩
...
def threshold : NonnegativeRatio := NonnegativeRatio.ofNat 365
...
end CertifiedJL.SparseUpperContourFamily.Instances.Rows256Bits152Threshold365Soundness
