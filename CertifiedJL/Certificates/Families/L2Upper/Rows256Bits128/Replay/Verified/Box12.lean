import CertifiedJL.Certificates.Families.L2Upper.Rows256Bits128.Replay.Shards.Box12.Shard00
import CertifiedJL.Certificates.Families.L2Upper.Rows256Bits128.Replay.Shards.Box12.Shard01
import CertifiedJL.Certificates.Families.L2Upper.Rows256Bits128.Replay.Shards.Box12.Shard02
import CertifiedJL.Certificates.Families.L2Upper.Rows256Bits128.Replay.Shards.Box12.Shard03

namespace CertifiedJL.SparseUpperHybrid

open UpperContourKernel

private def certificate : CertificateBox := certificateBoxes.getD 12 default

private def generatedCertificate : CertificateBox :=
  ⟨⟨3 / 512, 1 / 128, 627 / 1000, 8, 4 / 5⟩,
    [ ⟨0, 1 / 125, 125⟩,
      ⟨1, 1 / 13, 13⟩,
      ⟨2, 1 / 9, 18⟩,
      ⟨4, 1, 4⟩,
...
private theorem computedChunks_eq_generated :
    (certificateChunkPlan certificate).map (certificateChunkValue certificate) =
      SparseUpperHybridGenerated.Box12.chunks := by
  ...
  rw [Internal.Box12.chunk_000,
    Internal.Box12.chunk_001,
    Internal.Box12.chunk_002,
    Internal.Box12.chunk_003,
    Internal.Box12.chunk_004,
    Internal.Box12.chunk_005,
    Internal.Box12.chunk_006,
    Internal.Box12.chunk_007,
    Internal.Box12.chunk_008,
    Internal.Box12.chunk_009,
    Internal.Box12.chunk_010,
    Internal.Box12.chunk_011,
    Internal.Box12.chunk_012,
    Internal.Box12.chunk_013,
    Internal.Box12.chunk_014,
    Internal.Box12.chunk_015,
    Internal.Box12.chunk_016,
    Internal.Box12.chunk_017]
  norm_num [SparseUpperHybridGenerated.Box12.chunk,
...
private theorem segment0_chunkRanges_cover :
    chunkRangesCover 125 segment0_chunkRanges = true := by
  decide +kernel

private theorem segment0_chunkRanges_sideChecks :
    segment0_chunkRanges.all (fun chunk =>
      segmentChunkSideCheck ⟨3 / 512, 1 / 128, 627 / 1000, 8, 4 / 5⟩ ⟨0, 1 / 125, 125⟩
        chunk.1 chunk.2) = true := by
  simp only [segment0_chunkRanges, List.all_cons, List.all_nil, Bool.and_eq_true]
  exact ⟨Internal.Box12.chunk_000_sideCheck,
    Internal.Box12.chunk_001_sideCheck,
    Internal.Box12.chunk_002_sideCheck,
    Internal.Box12.chunk_003_sideCheck,
    Internal.Box12.chunk_004_sideCheck,
    Internal.Box12.chunk_005_sideCheck,
    Internal.Box12.chunk_006_sideCheck,
    Internal.Box12.chunk_007_sideCheck,
    Internal.Box12.chunk_008_sideCheck,
    Internal.Box12.chunk_009_sideCheck,
    Internal.Box12.chunk_010_sideCheck,
    Internal.Box12.chunk_011_sideCheck,
    Internal.Box12.chunk_012_sideCheck,
    True.intro⟩
...
private theorem segment1_chunkRanges_sideChecks :
    segment1_chunkRanges.all (fun chunk =>
      segmentChunkSideCheck ⟨3 / 512, 1 / 128, 627 / 1000, 8, 4 / 5⟩ ⟨1, 1 / 13, 13⟩
        chunk.1 chunk.2) = true := by
  simp only [segment1_chunkRanges, List.all_cons, List.all_nil, Bool.and_eq_true]
  exact ⟨Internal.Box12.chunk_013_sideCheck,
    Internal.Box12.chunk_014_sideCheck,
    True.intro⟩
...
private theorem segment2_chunkRanges_cover :
    chunkRangesCover 18 segment2_chunkRanges = true := by
  decide +kernel

private theorem segment2_chunkRanges_sideChecks :
    segment2_chunkRanges.all (fun chunk =>
      segmentChunkSideCheck ⟨3 / 512, 1 / 128, 627 / 1000, 8, 4 / 5⟩ ⟨2, 1 / 9, 18⟩
        chunk.1 chunk.2) = true := by
  simp only [segment2_chunkRanges, List.all_cons, List.all_nil, Bool.and_eq_true]
  exact ⟨Internal.Box12.chunk_015_sideCheck,
    Internal.Box12.chunk_016_sideCheck,
    True.intro⟩
...
private theorem segment3_chunkRanges_sideChecks :
    segment3_chunkRanges.all (fun chunk =>
      segmentChunkSideCheck ⟨3 / 512, 1 / 128, 627 / 1000, 8, 4 / 5⟩ ⟨4, 1, 4⟩
        chunk.1 chunk.2) = true := by
  simp only [segment3_chunkRanges, List.all_cons, List.all_nil, Bool.and_eq_true]
  exact ⟨Internal.Box12.chunk_017_sideCheck,
    True.intro⟩
...
private theorem segment4_chunkRanges_sideChecks :
    segment4_chunkRanges.all (fun chunk =>
      segmentChunkSideCheck ⟨3 / 512, 1 / 128, 627 / 1000, 8, 4 / 5⟩ ⟨8, 1, 0⟩
        chunk.1 chunk.2) = true := by rfl


theorem certificate_12_finiteTail_lo_eq_zero :
    (finiteIntegralFrom
      ((certificateChunkPlan (certificateBoxes.getD 12 default)).map
        (certificateChunkValue (certificateBoxes.getD 12 default))) +
      tail (certificateBoxes.getD 12 default).box).lo = 0 := by
...
theorem certificate_12_finiteTail_nonneg :
    0 ≤ (finiteIntegralFrom
      ((certificateChunkPlan (certificateBoxes.getD 12 default)).map
        (certificateChunkValue (certificateBoxes.getD 12 default))) +
      tail (certificateBoxes.getD 12 default).box).lo := by
  rw [certificate_12_finiteTail_lo_eq_zero]

theorem certificate_12_finiteTail_valid :
    (finiteIntegralFrom
      ((certificateChunkPlan (certificateBoxes.getD 12 default)).map
        (certificateChunkValue (certificateBoxes.getD 12 default))) +
      tail (certificateBoxes.getD 12 default).box).Valid := by
  change (finiteIntegralFrom
    ((certificateChunkPlan certificate).map (certificateChunkValue certificate)) +
      tail certificate.box).Valid
  rw [computedChunks_eq_generated, certificate_eq_generated]
  change (finiteIntegralFrom SparseUpperHybridGenerated.Box12.chunks +
      tail generatedCertificate.box).lo ≤
    (finiteIntegralFrom SparseUpperHybridGenerated.Box12.chunks +
      tail generatedCertificate.box).hi
  decide +kernel

set_option maxRecDepth 10000 in
theorem certificate_12_sideChecks :
    ∀ segment ∈ (certificateBoxes.getD 12 default).segments,
      ∀ i < segment.count,
        hybridCellSideCheck (certificateBoxes.getD 12 default).box
          segment i = true := by
...
private def generatedBound : DInterval precision :=
  boxBoundFrom certificate.box SparseUpperHybridGenerated.Box12.chunks

private theorem generatedCheck :
    Interval.upperLTCheck generatedBound 1 = true := by
  decide +kernel

theorem certificate_12_upperRat_lt :
    (certificateBound (certificateBoxes.getD 12 default)).upperRat < 1 := by
