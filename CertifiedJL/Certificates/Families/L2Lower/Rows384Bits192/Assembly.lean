...
import CertifiedJL.Certificates.Families.L2Lower.Rows384Bits192.Soundness.ThresholdBits384Bits192
...
/-! # Exact assembly for 384 rows, squared-norm floor 43, and 192 bits -/
...
private theorem dominantReplay
    (direct : CertificateContracts.SparseL2ThresholdDominantDirectCover384Bits192)
    (capped : CertificateContracts.SparseL2ThresholdDominantCappedFourierCover384Bits192)
    (singleton : CertificateContracts.SparseL2ThresholdDominantSingletonFourierCover384Bits192)
    ...
    (retainedRatio : CertificateContracts.SparseL2ThresholdDominantFinalRatio384Bits192) :
    CertificateContracts.SparseL2ThresholdDominantReplayAt
      384 43 highBudget where
  directCover := by
...
/-- The fully kernel-checked 384/43/192 threshold-relative lower-tail
assembly. -/
theorem sparseL2ThresholdLower384Bits192 :
    CertificateContracts.SparseL2ThresholdDominantDirectCover384Bits192 →
    CertificateContracts.SparseL2ThresholdDominantCappedFourierCover384Bits192 →
    CertificateContracts.SparseL2ThresholdDominantSingletonFourierCover384Bits192 →
    ...
    CertificateContracts.SparseL2ThresholdDominantFinalRatio384Bits192 →
    ...
    CertificateContracts.SparseL2ThresholdNearFinalRatio384Bits192 →
    ...
    CertificateContracts.SparseL2ThresholdDiffuseFinalRatio384Bits192 →
  ...
  let config := Threshold384Bits192.config
  ...
  have hgeneric : L2ThresholdLowerTailAt
    ...
    · exact Threshold384Bits192.budgets_add.le
    · intro d i
      exact Threshold384Bits192.lowActivity i
    · exact sparseThresholdDominantHighActivity_of_replay_at config
        ...
        highBudget_pos (by
          simpa [config, Threshold384Bits192.config, highBudget_eq] using
            Threshold384Bits192.highBudget_real)
    · exact hnear
    · exact hdiffuse
    · simpa [CertificateContracts.SparseL2ThresholdNearFinalRatio384Bits192,
        config, Threshold384Bits192.config, inv_pow, mul_comm] using
        nearRatio
    · simpa [CertificateContracts.SparseL2ThresholdDiffuseFinalRatio384Bits192,
        config, Threshold384Bits192.config, inv_pow, mul_comm] using
        diffuseRatio
  simpa [config, Threshold384Bits192.config, ThresholdTailConfig.parameters,
