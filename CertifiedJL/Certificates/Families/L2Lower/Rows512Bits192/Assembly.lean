...
import CertifiedJL.Certificates.Families.L2Lower.Rows512Bits192.Soundness.ThresholdBits512Bits192
...
/-! # Exact assembly for 512 rows, squared-norm floor 71, and 192 bits -/
...
private theorem dominantReplay
    (direct : CertificateContracts.SparseL2ThresholdDominantDirectCover512Bits192)
    (capped : CertificateContracts.SparseL2ThresholdDominantCappedFourierCover512Bits192)
    (singleton : CertificateContracts.SparseL2ThresholdDominantSingletonFourierCover512Bits192)
    ...
    (retainedRatio : CertificateContracts.SparseL2ThresholdDominantFinalRatio512Bits192) :
    CertificateContracts.SparseL2ThresholdDominantReplayAt
      512 71 highBudget where
  directCover := by
...
/-- The fully kernel-checked 512/71/192 threshold-relative lower-tail
assembly. -/
theorem sparseL2ThresholdLower512Bits192 :
    CertificateContracts.SparseL2ThresholdDominantDirectCover512Bits192 →
    CertificateContracts.SparseL2ThresholdDominantCappedFourierCover512Bits192 →
    CertificateContracts.SparseL2ThresholdDominantSingletonFourierCover512Bits192 →
    ...
    CertificateContracts.SparseL2ThresholdDominantFinalRatio512Bits192 →
    ...
    CertificateContracts.SparseL2ThresholdNearFinalRatio512Bits192 →
    ...
    CertificateContracts.SparseL2ThresholdDiffuseFinalRatio512Bits192 →
  ...
  let config := Threshold512Bits192.config
  ...
  have hgeneric : L2ThresholdLowerTailAt
    ...
    · exact Threshold512Bits192.budgets_add.le
    · intro d i
      exact Threshold512Bits192.lowActivity i
    · exact sparseThresholdDominantHighActivity_of_replay_at config
        ...
        highBudget_pos (by
          simpa [config, Threshold512Bits192.config, highBudget_eq] using
            Threshold512Bits192.highBudget_real)
    · exact hnear
    · exact hdiffuse
    · simpa [CertificateContracts.SparseL2ThresholdNearFinalRatio512Bits192,
        config, Threshold512Bits192.config, inv_pow, mul_comm] using
        nearRatio
    · simpa [CertificateContracts.SparseL2ThresholdDiffuseFinalRatio512Bits192,
        config, Threshold512Bits192.config, inv_pow, mul_comm] using
        diffuseRatio
  simpa [config, Threshold512Bits192.config, ThresholdTailConfig.parameters,
