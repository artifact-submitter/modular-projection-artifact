...
/-! # Complete low-singleton modulus cover at 128 bits -/
...
def cell00 : Cell :=
  { lower := 40/20, upper := 41/20,
    thresholdUpper := (41 / 20) ^ 2 / 9, rowUpper := 622/1000 }
def cell01 : Cell :=
  { lower := 41/20, upper := 42/20,
    thresholdUpper := (42 / 20) ^ 2 / 9, rowUpper := 614/1000 }
def cell02 : Cell :=
  { lower := 42/20, upper := 43/20,
    thresholdUpper := (43 / 20) ^ 2 / 9, rowUpper := 606/1000 }
def cell03 : Cell :=
  { lower := 43/20, upper := 44/20,
    thresholdUpper := (44 / 20) ^ 2 / 9, rowUpper := 601/1000 }
def cell04 : Cell :=
  { lower := 44/20, upper := 45/20,
    thresholdUpper := (45 / 20) ^ 2 / 9, rowUpper := 596/1000 }
def cell05 : Cell :=
  { lower := 45/20, upper := 46/20,
    thresholdUpper := (46 / 20) ^ 2 / 9, rowUpper := 592/1000 }
def cell06 : Cell :=
  { lower := 46/20, upper := 47/20,
    thresholdUpper := (47 / 20) ^ 2 / 9, rowUpper := 590/1000 }
def cell07 : Cell :=
  { lower := 47/20, upper := 48/20,
    thresholdUpper := (48 / 20) ^ 2 / 9, rowUpper := 588/1000 }
def cell08 : Cell :=
  { lower := 48/20, upper := 49/20,
    thresholdUpper := (49 / 20) ^ 2 / 9, rowUpper := 588/1000 }
def cell09 : Cell :=
  { lower := 49/20, upper := 50/20,
    thresholdUpper := (50 / 20) ^ 2 / 9, rowUpper := 588/1000 }
