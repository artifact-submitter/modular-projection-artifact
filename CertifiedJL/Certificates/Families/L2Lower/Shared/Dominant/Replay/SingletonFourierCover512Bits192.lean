...
/-! # Replayed singleton-Fourier cover for 512 rows at 192 bits -/

namespace CertifiedJL.SparseThresholdDominant.SingletonFourierCover512Bits192
...
theorem exists_cover_cell {B r : ℝ}
  ...
  exact ⟨cell, hmem, hlower, hupper, hthreshold,
    certifiedCheckAt_geometry 512 71 budget cell hcert,
    certifiedCheckAt_sound 512 71 budget cell hcert⟩

end CertifiedJL.SparseThresholdDominant.SingletonFourierCover512Bits192
