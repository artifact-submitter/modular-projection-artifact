...
/-! # Replayed capped-Fourier cover for 384 rows at 192 bits
...
namespace CertifiedJL.SparseThresholdDominant.CappedFourierCover384Bits192
...
theorem exists_cover_cell {B r : ℝ}
  ...
  have hgeometry := certifiedCheckAt_geometry 384 43 budget cell hcert
  exact ⟨cell, hmem, hlower, hupper, hthreshold, hgeometry.1,
    hgeometry.2, certifiedCheckAt_sound 384 43 budget cell hcert⟩

end CertifiedJL.SparseThresholdDominant.CappedFourierCover384Bits192
