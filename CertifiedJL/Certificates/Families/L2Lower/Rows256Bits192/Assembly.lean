...
import CertifiedJL.Certificates.Families.L2Lower.Rows256Bits192.Soundness.ThresholdBits256Bits192
...
/-! # Exact assembly for 256 rows, squared-norm floor 9, and 192 bits -/
...
private theorem highBudget_eq :
    highBudget = (99 / 100 : ℝ) * (2 : ℝ)⁻¹ ^ 192 := by
  unfold highBudget
...
private theorem dominantReplay
    (direct : CertificateContracts.SparseL2ThresholdDominantDirectCover256Bits192)
    (capped : CertificateContracts.SparseL2ThresholdDominantCappedFourierCover256Bits192)
    (singleton : CertificateContracts.SparseL2ThresholdDominantSingletonFourierCover256Bits192)
    ...
    (retainedRatio : CertificateContracts.SparseL2ThresholdDominantFinalRatio256Bits192) :
    CertificateContracts.SparseL2ThresholdDominantTiltedReplayAt
      256 9 (7 / 2) (13 / 4) highBudget where
  ...
  cappedFourierCover := by
    intro B r
    simpa [CertificateContracts.SparseL2ThresholdDominantCappedFourierCover256Bits192,
      highBudget] using @capped B r
  singletonFourierCover := by
    intro B r
    simpa [CertificateContracts.SparseL2ThresholdDominantSingletonFourierCover256Bits192,
...
/-- The fully kernel-checked 256/9/192 threshold-relative lower-tail
assembly. -/
theorem sparseL2ThresholdLower256Bits192 :
    CertificateContracts.SparseL2ThresholdDominantDirectCover256Bits192 →
    CertificateContracts.SparseL2ThresholdDominantCappedFourierCover256Bits192 →
    CertificateContracts.SparseL2ThresholdDominantSingletonFourierCover256Bits192 →
    ...
    CertificateContracts.SparseL2ThresholdDominantFinalRatio256Bits192 →
    ...
    CertificateContracts.SparseL2ThresholdNearFinalRatio256Bits192 →
    ...
    CertificateContracts.SparseL2ThresholdDiffuseFinalRatio256Bits192 →
  ...
  let config := Threshold256Bits192.config
  ...
  have hgeneric : L2ThresholdLowerTailAt
    ...
    · exact Threshold256Bits192.budgets_add.le
    · intro d i
      exact Threshold256Bits192.lowActivity i
    · exact sparseThresholdDominantHighActivity_of_tiltedReplay_at config
        ...
        highBudget_pos (by
          simpa [config, Threshold256Bits192.config, highBudget_eq] using
            Threshold256Bits192.highBudget_real)
    · exact hnear
    · exact hdiffuse
    · simpa [CertificateContracts.SparseL2ThresholdNearFinalRatio256Bits192,
        config, Threshold256Bits192.config, inv_pow, mul_comm] using
        nearRatio
    · simpa [CertificateContracts.SparseL2ThresholdDiffuseFinalRatio256Bits192,
        config, Threshold256Bits192.config, inv_pow, mul_comm] using
        diffuseRatio
  simpa [config, Threshold256Bits192.config, ThresholdTailConfig.parameters,
