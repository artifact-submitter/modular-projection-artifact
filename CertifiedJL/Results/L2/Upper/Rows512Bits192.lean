...
import CertifiedJL.Certificates.Families.L2Upper.Rows512Bits192.Provider
import CertifiedJL.Projection.L2.Upper.BalancedTernary.UpperFinal
import CertifiedJL.Statements.L2.Upper

/-! # Certified 512-row balanced-ternary modular tails at 192 bits -/

namespace CertifiedJL.Results.L2.Upper.Rows512Bits192
...
private theorem normalizedTernaryL2Upper607
  ...
  exact CertificateAssembly.normalizedTernaryL2Upper607
    CertificateProviders.sparseL2UpperContour512Bits192_verified a hnorm

/-- Balanced-ternary modular squared-Euclidean upper tail at
threshold `607 * ‖w‖₂²`.  This theorem has no modulus or input-norm
restriction. -/
...
end CertifiedJL.Results.L2.Upper.Rows512Bits192
