...
namespace CertifiedJL.Results.LInf.Upper.Rows512Bits192

open scoped BigOperators ENNReal

/-- Elementary balanced-ternary modular infinity upper tail at the
two-decimal coordinate threshold `11.84 * ‖w‖₂`, with no modulus
restriction. -/
theorem ternaryLInfUpper1184Over100 :
    LInfUpperTailAt
...
end CertifiedJL.Results.LInf.Upper.Rows512Bits192
