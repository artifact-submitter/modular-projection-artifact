...
namespace CertifiedJL.Results.Affine.LInf.Lower.MarginTwo
...
theorem ternaryAffineLInfThresholdLower192Cap93Over500Margin2Bits129 :
  ...
  have h := CertifiedJL.Results.Affine.LInf.Lower.Endpoints.ternaryAffineLInfThresholdLower192Cap279Over1000Bits129.twoThirds
...
theorem ternaryAffineLInfThresholdLower256Cap4Over25Margin2Bits197 :
  ...
  have h := CertifiedJL.Results.Affine.LInf.Lower.Direct.ternaryAffineLInfThresholdLower256Cap6Over25Bits197.twoThirds
  intro q d w b shift hq hc hb hn hm
  have hmargin : InputThresholdWithinModulus
      (NonnegativeRatio.ofNat 3).twoThirds q b := by
    dsimp [InputThresholdWithinModulus, NonnegativeRatio.twoThirds,
...
theorem ternaryAffineLInfThresholdLower256Cap331Over1500Margin2Bits133 :
  ...
  have h := CertifiedJL.Results.Affine.LInf.Lower.Endpoints.ternaryAffineLInfThresholdLower256Cap331Over1000Bits133.twoThirds
  intro q d w b shift hq hc hb hn hm
  have hmargin : InputThresholdWithinModulus
      (NonnegativeRatio.ofNat 3).twoThirds q b := by
    dsimp [InputThresholdWithinModulus, NonnegativeRatio.twoThirds,
...
theorem ternaryAffineLInfThresholdLower384Cap331Over1500Margin2Bits200 :
  ...
  have h := CertifiedJL.Results.Affine.LInf.Lower.Endpoints.ternaryAffineLInfThresholdLower384Cap331Over1000Bits200.twoThirds
  intro q d w b shift hq hc hb hn hm
  have hmargin : InputThresholdWithinModulus
      (NonnegativeRatio.ofNat 3).twoThirds q b := by
    dsimp [InputThresholdWithinModulus, NonnegativeRatio.twoThirds,
...
theorem ternaryAffineLInfThresholdLower512Cap331Over1500Margin2Bits266 :
  ...
  have h := CertifiedJL.Results.Affine.LInf.Lower.Endpoints.ternaryAffineLInfThresholdLower512Cap331Over1000Bits266.twoThirds
  intro q d w b shift hq hc hb hn hm
  have hmargin : InputThresholdWithinModulus
      (NonnegativeRatio.ofNat 3).twoThirds q b := by
    dsimp [InputThresholdWithinModulus, NonnegativeRatio.twoThirds,
...
theorem ternaryAffineLInfThresholdLower512Cap92Over375Margin2Bits206 :
  ...
  have h := CertifiedJL.Results.Affine.LInf.Lower.Endpoints.ternaryAffineLInfThresholdLower512Cap46Over125Bits206.twoThirds
  intro q d w b shift hq hc hb hn hm
  have hmargin : InputThresholdWithinModulus
      (NonnegativeRatio.ofNat 3).twoThirds q b := by
    dsimp [InputThresholdWithinModulus, NonnegativeRatio.twoThirds,
...
theorem ternaryAffineLInfThresholdLower256Cap67Over300Margin2Bits130 :
  ...
  have h := CertifiedJL.Results.Affine.LInf.Lower.Direct.ternaryAffineLInfThresholdLower256Cap67Over200Bits130.twoThirds
  intro q d w b shift hq hc hb hn hm
  have hmargin : InputThresholdWithinModulus
      (NonnegativeRatio.ofNat 3).twoThirds q b := by
    dsimp [InputThresholdWithinModulus, NonnegativeRatio.twoThirds,
...
theorem ternaryAffineLInfThresholdLower256Cap6Over25Margin2Bits109 :
  ...
  have h := CertifiedJL.Results.Affine.LInf.Lower.Endpoints.ternaryAffineLInfThresholdLower256Cap9Over25Bits109.twoThirds
  intro q d w b shift hq hc hb hn hm
  have hmargin : InputThresholdWithinModulus
      (NonnegativeRatio.ofNat 3).twoThirds q b := by
    dsimp [InputThresholdWithinModulus, NonnegativeRatio.twoThirds,
...
theorem ternaryAffineLInfThresholdLower462Cap6Over25Margin2Bits197 :
    AffineLInfThresholdLowerTailAt
      { distribution := .balancedTernary, rows := 462,
        ...
        modulusMargin := NonnegativeRatio.ofNat 2 }
      (failureTarget 197) := by
  have h := CertifiedJL.Results.Affine.LInf.Lower.Endpoints.ternaryAffineLInfThresholdLower462Cap9Over25Bits197.twoThirds
  intro q d w b shift hq hc hb hn hm
  have hmargin : InputThresholdWithinModulus
      (NonnegativeRatio.ofNat 3).twoThirds q b := by
    dsimp [InputThresholdWithinModulus, NonnegativeRatio.twoThirds,
...
end CertifiedJL.Results.Affine.LInf.Lower.MarginTwo
