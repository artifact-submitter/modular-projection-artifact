...
namespace CertifiedJL.Results.Affine.L2.Lower.Endpoints
...
/-- The complete ten-member affine Euclidean endpoint family. -/
...
end CertifiedJL.Results.Affine.L2.Lower.Endpoints
